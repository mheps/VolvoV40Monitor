...
namespace Volvo.Application.Services
{
    ...
    public class SurusVerisiServisi
    {
        ...
        public SurusVerisiServisi(ISurusVerisiRepository repository) { _repository = repository; }
        public AracSurusVerisi MevcutVerileriGetir() { return _repository.Get(); }
        public void SurusVerileriniSifirla() { var d = _repository.Get(); d.VerileriSifirla(); _repository.Save(d); }
        public void SurusSimulasyonuYap(double mesafe, double yakit, int sure) { var d = _repository.Get(); d.SurusVerisiGuncelle(mesafe, yakit, sure); _repository.Save(d); }
    }
}